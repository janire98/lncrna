...
rutaDF <- "/Users/janire/Desktop/TFM/TFM_workflow/004_genes_rescaled(1,30)/Subread/subread_counts_rescalado.csv"
df <- read_csv(rutaDF)
...
numGenes <- as.numeric(100)
## ESCOJO EL PATH EN EL QUE GUARDAR EL ARCHIVO CLUSTER
camino <- "/Users/janire/Desktop/TFM/TFM_workflow/005_clusterings/Subread_100_counts_normal"
